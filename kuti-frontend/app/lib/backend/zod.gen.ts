...
export const zProjectList = z.array(
  z.object({
    id: z.string(),
    name: z.string(),
    slug: z.string(),
 ...
 * Response for status 200
 */
export const zListModelsResponse = z.array(
  z.object({
    key: z.string(),
    kind: z.enum(["image", "video", "audio", "text"]),
    displayName: z.string(),
    baseUrl: z.union([z.string(), z.unknown()]),
    enabled: z.boolean(),
 ...
 * Response for status 200
 */
export const zListProjectsResponse = z.array(
  z.object({
    id: z.string(),
    name: z.string(),
    slug: z.string(),
...
export const zUpdateProjectBody = z.object({
  name: z.string().min(1).max(255).optional(),
  status: z.enum(["draft", "active", "archived", "maintenance"]).optional(),
  settingsJson: z.record(z.unknown()).optional(),
});
 ...
 * Response for status 200
 */
export const zListCharactersResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    slug: z.string(),
    name: z.string(),
    alias: z.union([z.string(), z.unknown()]),
    narrativeRole: z.union([z.string(), z.unknown()]),
...
export const zCreateCharacterBody = z.object({
  name: z.string().min(1).max(255),
  alias: z.union([z.string().max(255), z.unknown()]).optional(),
  narrativeRole: z.union([z.string().max(255), z.unknown()]).optional(),
 ...
 * Response for status 200
 */
export const zGetProjectCharacterImagesResponse = z.record(
  z.array(
    z.object({
      id: z.string(),
      projectId: z.string(),
      ...
      publicUrl: z.string(),
      fileName: z.string(),
      fileSize: z.union([z.number(), z.unknown()]),
      mimeType: z.string(),
      prompt: z.string(),
      strategy: z.union([z.string(), z.unknown()]),
      style: z.union([z.string(), z.unknown()]),
      variationIndex: z.union([z.number(), z.unknown()]),
      createdAt: z
        .string()
        .datetime()
        .regex(
...
export const zGetCharacterResponse = z.object({
  ...
  voiceSamples: z.array(
    z.object({
      id: z.string(),
      projectId: z.string(),
      characterId: z.string(),
      assetPath: z.union([z.string(), z.unknown()]),
      label: z.string(),
      voiceNotes: z.string(),
      createdAt: z
        .string()
  ...
  relationshipsSummary: z.union([z.string(), z.unknown()]),
});
 ...
 * Response for status 200
 */
export const zListCharacterImagesResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    characterId: z.string(),
 ...
 * Response for status 200
 */
export const zListStoryCompletionModelsResponse = z.array(
  z.object({
    key: z.string(),
    displayName: z.string(),
    enabled: z.boolean(),
...
export const zCompleteStoryFieldBody = z.object({
  targetKind: z.enum(["tome", "chapter", "scene"]),
  targetId: z.string(),
  field: z.enum([
    "title",
    "sceneType",
...
export const zCreateGenerationJobResponse = z.object({
  ...
  sourceVersionId: z.union([z.string(), z.unknown()]),
  strategy: z.enum(["direct", "intermediate"]),
  entrypoint: z.string(),
  title: z.string(),
  prompt: z.string(),
  summary: z.string(),
  status: z.enum(["pending", "running", "ready", "validated", "failed"]),
  progress: z.number(),
  ...
  errorMessage: z.union([z.string(), z.unknown()]),
});
...
export const zGetGenerationBoardResponse = z.object({
  ...
  artifactPath: z.union([z.string(), z.unknown()]),
  artifactName: z.union([z.string(), z.unknown()]),
  metadataJson: z.record(z.unknown()),
  createdAt: z
    .string()
    .datetime()
  ...
  panels: z.array(
    z.object({
      id: z.string(),
      boardId: z.string(),
      stepId: z.union([z.string(), z.unknown()]),
      orderIndex: z.number(),
      title: z.string(),
      caption: z.string(),
      prompt: z.string(),
      status: z.enum(["draft", "selected", "rejected", "replaced"]),
      imagePath: z.string(),
      imageName: z.string(),
      metadataJson: z.record(z.unknown()),
      createdAt: z
...
export const zUpdateGenerationPanelBody = z.object({
  status: z.enum(["draft", "selected", "rejected", "replaced"]).optional(),
 ...
 * Response for status 200
 */
export const zListProjectDramaVideosResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    sourceMangaPageId: z.union([z.string(), z.unknown()]),
    jobId: z.union([z.string(), z.unknown()]),
    title: z.string(),
    prompt: z.string(),
    modelKey: z.string(),
    ...
    videoUrl: z.union([z.string(), z.unknown()]),
    durationSeconds: z.union([z.number(), z.unknown()]),
    ...
    source: z.union([
      z.object({
        ...
        pageNumber: z.number(),
        pageLabel: z.string(),
        pageImageUrl: z.union([z.string(), z.unknown()]),
      }),
      z.unknown(),
    ]),
    createdAt: z.string(),
    updatedAt: z.string(),
    completedAt: z.union([z.string(), z.unknown()]),
    failedAt: z.union([z.string(), z.unknown()]),
    errorMessage: z.union([z.string(), z.unknown()]),
  }),
);
...
export const zArchiveDramaVideoResponse = z.object({
  ...
  modelKey: z.string(),
  stylePreset: z.string(),
  status: z.enum(["draft", "queued", "running", "ready", "failed", "archived"]),
  videoUrl: z.union([z.string(), z.unknown()]),
  durationSeconds: z.union([z.number(), z.unknown()]),
  metadata: z.record(z.unknown()),
  source: z.union([
 ...
 * Response for status 200
 */
export const zListAssetsResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    slug: z.string(),
    ...
    createdAt: z.string(),
    updatedAt: z.string(),
    archivedAt: z.union([z.string(), z.unknown()]),
  }),
);
 ...
 * Response for status 200
 */
export const zListSceneConfigsResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    name: z.string(),
    ...
    stylePreset: z.enum(["shonen", "shojo", "seinen", "generic"]),
    colorMode: z.enum(["bw", "color", "spot_color"]),
...
export const zCreateSceneConfigBody = z.object({
  ...
  stylePreset: z
    .enum(["shonen", "shojo", "seinen", "generic"])
    .default("generic"),
  colorMode: z.enum(["bw", "color", "spot_color"]).default("bw"),
...
export const zUpdateSceneConfigBody = z.object({
  ...
  stylePreset: z.enum(["shonen", "shojo", "seinen", "generic"]).optional(),
  colorMode: z.enum(["bw", "color", "spot_color"]).optional(),
 ...
 * Response for status 200
 */
export const zListSceneMangaPagesResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    sceneId: z.string(),
    ...
    caption: z.union([z.string(), z.unknown()]),
...
export const zUpdateSceneMangaPageBody = z.object({
  ...
  status: z.enum(["draft", "selected", "rejected"]).optional(),
 ...
 * Response for status 200
 */
export const zListDramaVideosResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    sourceMangaPageId: z.union([z.string(), z.unknown()]),
 ...
 * Response for status 200
 */
export const zListMangaPageDramaVideosResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    sourceMangaPageId: z.union([z.string(), z.unknown()]),
 ...
 * Response for status 200
 */
export const zListVersionsResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    branchName: z.string(),
 ...
 * Response for status 200
 */
export const zListBranchesResponse = z.array(
  z.object({
    branchName: z.string(),
    versionCount: z.number(),
    latestVersionId: z.union([z.string(), z.unknown()]),
    latestVersionLabel: z.union([z.string(), z.unknown()]),
 ...
 * Response for status 200
 */
export const zListWarningsResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
...
export const zListExportsQuery = z.object({
  ...
  format: z
    .enum(["json", "tree", "zip", "paged_images", "pdf", "cbz", "epub"])
    .optional(),
});
 ...
 * Response for status 200
 */
export const zListExportsResponse = z.array(
  z.object({
    id: z.string(),
    projectId: z.string(),
    ...
    artifactName: z.union([z.string(), z.unknown()]),
    metadataJson: z.record(z.unknown()),
    sizeBytes: z.union([z.number(), z.unknown()]),
    createdAt: z
      .string()
      .datetime()
      .regex(
...
export const zCreateExportResponse = z.object({
  ...
  projectId: z.string(),
  kind: z.enum(["work", "publication"]),
  format: z.enum(["json", "tree", "zip", "paged_images", "pdf", "cbz", "epub"]),
  status: z.enum(["pending", "ready", "failed"]),
  label: z.string(),
  summary: z.string(),
  artifactPath: z.union([z.string(), z.unknown()]),
