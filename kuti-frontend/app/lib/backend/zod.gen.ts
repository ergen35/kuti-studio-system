...
export const zImportProjectBody = z.object({
 ...
 * Response for status 200
 */
export const zImportProjectResponse = z.object({
    id: z.string(),
    name: z.string(),
    slug: z.string(),
    status: z.enum([
...
export const zListNarrativeRolesPath = z.object({
    projectId: z.string()
});
 ...
 * Response for status 200
 */
export const zListNarrativeRolesResponse = z.array(z.object({
    id: z.string(),
    projectId: z.string(),
    code: z.string(),
    label: z.string(),
...
export const zCreateNarrativeRoleBody = z.object({
    label: z.string().min(1).max(255)
});

export const zCreateNarrativeRolePath = z.object({
    projectId: z.string()
});
 ...
 * Response for status 200
 */
export const zCreateNarrativeRoleResponse = z.object({
    id: z.string(),
    projectId: z.string(),
    code: z.string(),
    label: z.string(),
...
export const zGetProjectCharacterImagesResponse = z.record(z.array(z.object({
    ...
    isActive: z.boolean(),
    sourceImageId: z.union([
        z.string(),
        z.unknown()
    ]),
    boardPanelId: z.union([
        z.string(),
        z.unknown()
    ]),
    filePath: z.string(),
...
export const zDeleteRelationPath = z.object({
    projectId: z.string(),
    characterId: z.string(),
    relationId: z.string()
});

export const zUpdateRelationBody = z.object({
    relationType: z.string().min(1).optional(),
    strength: z.number().gte(0).lte(100).optional(),
    narrativeDependency: z.string().optional(),
    notes: z.string().optional()
});

export const zUpdateRelationPath = z.object({
    projectId: z.string(),
    characterId: z.string(),
    relationId: z.string()
});
...
export const zGenerateCharacterProfileDraftBody = z.object({
    descriptionMinimal: z.string().min(1).max(2000),
    modelKey: z.string().optional()
});

export const zGenerateCharacterProfileDraftPath = z.object({
    projectId: z.string(),
    characterId: z.string()
});
 ...
 * Response for status 200
 */
export const zGenerateCharacterProfileDraftResponse = z.object({
    description: z.string(),
    physicalDescription: z.string(),
    keyTraitsJson: z.array(z.string()),
    colorPaletteJson: z.array(z.string()),
...
export const zSetCharacterImageActivePath = z.object({
    projectId: z.string(),
    characterId: z.string(),
    imageId: z.string()
});
 ...
 * Response for status 200
 */
export const zSetCharacterImageActiveResponse = z.object({
    id: z.string(),
    projectId: z.string(),
    characterId: z.string(),
    kind: z.enum(['character_sheet', 'free_image']),
...
export const zAutoGenerateChapterScenesBody = z.object({
    chapterSummary: z.string().min(1000),
    sceneCount: z.number().int().gte(1).lte(8)
});

export const zAutoGenerateChapterScenesPath = z.object({
    projectId: z.string(),
    chapterId: z.string()
});
 ...
 * Response for status 200
 */
export const zAutoGenerateChapterScenesResponse = z.object({
    jobId: z.string()
});

export const zListChapterMangaPagesPath = z.object({
    projectId: z.string(),
    chapterId: z.string()
});
 ...
 * Response for status 200
 */
export const zListChapterMangaPagesResponse = z.array(z.object({
    id: z.string(),
    projectId: z.string(),
    sceneId: z.string(),
    sceneTitle: z.string(),
...
export const zArchiveDramaVideoPath = z.object({
    projectId: z.string().uuid().regex(/^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/),
 ...
 * Response for status 200
 */
export const zArchiveDramaVideoResponse = z.object({
    id: z.string(),
    projectId: z.string(),
    sourceMangaPageId: z.union([
        z.string(),
...
export const zUpdateSceneMangaPageBody = z.object({
    ...
    pageNumber: z.number().int().gte(1).lte(9007199254740991).optional(),
    metadataJson: z.object({
        readyForExport: z.boolean().optional()
    }).optional()
});
 ...
 * Response for status 200
 */
export const zListVersionsResponse = z.array(z.object({
    id: z.string(),
    projectId: z.string(),
    branchName: z.string(),
    ...
    snapshot: z.union([
        z.object({
            ...
            capturedAt: z.string().datetime().regex(/^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/),
            project: z.object({
                id: z.string(),
                name: z.string(),
                slug: z.string(),
 ...
 * Response for status 200
 */
export const zListBranchesResponse = z.array(z.object({
    branchName: z.string(),
    versionCount: z.number(),
    latestVersionId: z.union([
        z.string(),
        z.unknown()
    ]),
    latestVersionLabel: z.union([
        z.string(),
        z.unknown()
    ]),
    latestCreatedAt: z.union([
        z.string().datetime().regex(/^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/),
        z.unknown()
    ]),
    latestSnapshotCapturedAt: z.union([
        z.string().datetime().regex(/^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$/),
        z.unknown()
    ]),
