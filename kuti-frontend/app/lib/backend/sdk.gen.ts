 ...
 */
export const listSceneTypes = <ThrowOnError extends boolean = false>(options: Options<ListSceneTypesData, ThrowOnError>) => (options.client ?? client).get<ListSceneTypesResponses, unknown, ThrowOnError>({ url: '/api/projects/{projectId}/story/scene-types', ...options });
