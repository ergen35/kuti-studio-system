...
import { archiveAsset, archiveCharacter, archiveDramaVideo, archiveProject, autoGenerateChapterScenes, cancelGenerationJob, cloneProject, compareVersions, completeStoryField, createAssetLink, createChapter, createCharacter, createExport, createGenerationJob, createNarrativeRole, createProject, createRelation, createScene, createSceneConfig, createTome, createVersion, createVoiceSample, deleteAsset, deleteAssetLink, deleteChapter, deleteCharacter, deleteCharacterImage, deleteProject, deleteRelation, deleteScene, deleteSceneConfig, deleteSceneMangaPage, deleteTome, downloadBoardArtifact, downloadExport, exportProject, generateCharacterImage, generateCharacterProfileDraft, generateDramaVideo, generateSceneManga, get_, getApiInngest, getAsset, getAssetFile, getCharacter, getConfig, getDramaVideoFile, getExport, getGenerationBoard, getGenerationJob, getGenerationPanelImage, getHealth, getHealthz, getIndex, getProject, getProjectCharacterImages, getReferenceSuggestions, getStorySummary, getVersion, importAsset, importProject, listAssets, listBranches, listChapterMangaPages, listChapters, listCharacterImages, listCharacters, listDramaVideos, listExports, listGenerationBoards, listGenerationJobs, listMangaPageDramaVideos, listModels, listNarrativeRoles, listProjectDramaVideos, listProjects, listSceneConfigs, listSceneMangaPages, listScenes, listStoryCompletionModels, listTomes, listVersions, listWarnings, openProject, type Options, postApiInngest, previewPrompt, putApiInngest, relaunchGenerationJob, restoreVersion, scanWarnings, setCharacterImageActive, setDefaultConfig, updateAsset, updateChapter, updateCharacter, updateGenerationPanel, updateProject, updateRelation, updateScene, updateSceneConfig, updateSceneMangaPage, updateTome, updateWarning, validateGenerationBoard } from '../sdk.gen';
import type { ArchiveAssetData, ArchiveAssetResponse, ArchiveCharacterData, ArchiveCharacterResponse, ArchiveDramaVideoData, ArchiveDramaVideoResponse, ArchiveProjectData, ArchiveProjectResponse, AutoGenerateChapterScenesData, AutoGenerateChapterScenesResponse, CancelGenerationJobData, CancelGenerationJobResponse, CloneProjectData, CloneProjectResponse, CompareVersionsData, CompareVersionsResponse, CompleteStoryFieldData, CompleteStoryFieldResponse, CreateAssetLinkData, CreateAssetLinkResponse, CreateChapterData, CreateChapterResponse, CreateCharacterData, CreateCharacterResponse, CreateExportData, CreateExportResponse, CreateGenerationJobData, CreateGenerationJobResponse, CreateNarrativeRoleData, CreateNarrativeRoleResponse, CreateProjectData, CreateProjectResponse, CreateRelationData, CreateRelationResponse, CreateSceneConfigData, CreateSceneConfigResponse, CreateSceneData, CreateSceneResponse, CreateTomeData, CreateTomeResponse, CreateVersionData, CreateVersionResponse, CreateVoiceSampleData, CreateVoiceSampleResponse, DeleteAssetData, DeleteAssetLinkData, DeleteChapterData, DeleteCharacterData, DeleteCharacterImageData, DeleteProjectData, DeleteProjectResponse, DeleteRelationData, DeleteSceneConfigData, DeleteSceneData, DeleteSceneMangaPageData, DeleteTomeData, DownloadBoardArtifactData, DownloadExportData, ExportProjectData, GenerateCharacterImageData, GenerateCharacterProfileDraftData, GenerateCharacterProfileDraftResponse, GenerateDramaVideoData, GenerateDramaVideoResponse, GenerateSceneMangaData, GenerateSceneMangaResponse, GetApiInngestData, GetAssetData, GetAssetFileData, GetAssetResponse, GetCharacterData, GetCharacterResponse, GetConfigData, GetConfigResponse, GetData, GetDramaVideoFileData, GetExportData, GetExportResponse, GetGenerationBoardData, GetGenerationBoardResponse, GetGenerationJobData, GetGenerationJobResponse, GetGenerationPanelImageData, GetHealthData, GetHealthResponse, GetHealthzData, GetIndexData, GetProjectCharacterImagesData, GetProjectCharacterImagesResponse, GetProjectData, GetProjectResponse, GetReferenceSuggestionsData, GetStorySummaryData, GetStorySummaryResponse, GetVersionData, GetVersionResponse, ImportAssetData, ImportAssetResponse, ImportProjectData, ImportProjectResponse, ListAssetsData, ListAssetsResponse, ListBranchesData, ListBranchesResponse, ListChapterMangaPagesData, ListChapterMangaPagesResponse, ListChaptersData, ListCharacterImagesData, ListCharacterImagesResponse, ListCharactersData, ListCharactersResponse, ListDramaVideosData, ListDramaVideosResponse, ListExportsData, ListExportsResponse, ListGenerationBoardsData, ListGenerationJobsData, ListMangaPageDramaVideosData, ListMangaPageDramaVideosResponse, ListModelsData, ListModelsResponse, ListNarrativeRolesData, ListNarrativeRolesResponse, ListProjectDramaVideosData, ListProjectDramaVideosResponse, ListProjectsData, ListProjectsResponse, ListSceneConfigsData, ListSceneConfigsResponse, ListSceneMangaPagesData, ListSceneMangaPagesResponse, ListScenesData, ListStoryCompletionModelsData, ListStoryCompletionModelsResponse, ListTomesData, ListVersionsData, ListVersionsResponse, ListWarningsData, ListWarningsResponse, OpenProjectData, OpenProjectResponse, PostApiInngestData, PreviewPromptData, PreviewPromptResponse, PutApiInngestData, RelaunchGenerationJobData, RelaunchGenerationJobResponse, RestoreVersionData, RestoreVersionResponse, ScanWarningsData, ScanWarningsResponse, SetCharacterImageActiveData, SetCharacterImageActiveResponse, SetDefaultConfigData, SetDefaultConfigResponse, UpdateAssetData, UpdateAssetResponse, UpdateChapterData, UpdateChapterResponse, UpdateCharacterData, UpdateCharacterResponse, UpdateGenerationPanelData, UpdateProjectData, UpdateProjectResponse, UpdateRelationData, UpdateRelationResponse, UpdateSceneConfigData, UpdateSceneConfigResponse, UpdateSceneData, UpdateSceneMangaPageData, UpdateSceneMangaPageResponse, UpdateSceneResponse, UpdateTomeData, UpdateTomeResponse, UpdateWarningData, UpdateWarningResponse, ValidateGenerationBoardData, ValidateGenerationBoardResponse } from '../types.gen';
 ...
 */
export const importProjectMutation = (options?: Partial<Options<ImportProjectData>>): UseMutationOptions<ImportProjectResponse, DefaultError, Options<ImportProjectData>> => {
    const mutationOptions: UseMutationOptions<ImportProjectResponse, DefaultError, Options<ImportProjectData>> = {
        mutationFn: async (fnOptions) => {
...
export const listNarrativeRolesQueryKey = (options: Options<ListNarrativeRolesData>) => createQueryKey('listNarrativeRoles', options);

/**
 * List narrative roles for a project
 */
export const listNarrativeRolesOptions = (options: Options<ListNarrativeRolesData>) => queryOptions<ListNarrativeRolesResponse, DefaultError, ListNarrativeRolesResponse, ReturnType<typeof listNarrativeRolesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listNarrativeRoles({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listNarrativeRolesQueryKey(options)
});

/**
 * Create a narrative role for a project
 */
export const createNarrativeRoleMutation = (options?: Partial<Options<CreateNarrativeRoleData>>): UseMutationOptions<CreateNarrativeRoleResponse, DefaultError, Options<CreateNarrativeRoleData>> => {
    const mutationOptions: UseMutationOptions<CreateNarrativeRoleResponse, DefaultError, Options<CreateNarrativeRoleData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createNarrativeRole({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteRelationMutation = (options?: Partial<Options<DeleteRelationData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteRelationData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteRelationData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const updateRelationMutation = (options?: Partial<Options<UpdateRelationData>>): UseMutationOptions<UpdateRelationResponse, DefaultError, Options<UpdateRelationData>> => {
    const mutationOptions: UseMutationOptions<UpdateRelationResponse, DefaultError, Options<UpdateRelationData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const generateCharacterProfileDraftMutation = (options?: Partial<Options<GenerateCharacterProfileDraftData>>): UseMutationOptions<GenerateCharacterProfileDraftResponse, DefaultError, Options<GenerateCharacterProfileDraftData>> => {
    const mutationOptions: UseMutationOptions<GenerateCharacterProfileDraftResponse, DefaultError, Options<GenerateCharacterProfileDraftData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await generateCharacterProfileDraft({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const setCharacterImageActiveMutation = (options?: Partial<Options<SetCharacterImageActiveData>>): UseMutationOptions<SetCharacterImageActiveResponse, DefaultError, Options<SetCharacterImageActiveData>> => {
    const mutationOptions: UseMutationOptions<SetCharacterImageActiveResponse, DefaultError, Options<SetCharacterImageActiveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setCharacterImageActive({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listStoryCompletionModelsQueryKey = (options: Options<ListStoryCompletionModelsData>) => createQueryKey('listStoryCompletionModels', options);

/**
 * List story completion models
 */
export const listStoryCompletionModelsOptions = (options: Options<ListStoryCompletionModelsData>) => queryOptions<ListStoryCompletionModelsResponse, DefaultError, ListStoryCompletionModelsResponse, ReturnType<typeof listStoryCompletionModelsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const completeStoryFieldMutation = (options?: Partial<Options<CompleteStoryFieldData>>): UseMutationOptions<CompleteStoryFieldResponse, DefaultError, Options<CompleteStoryFieldData>> => {
    const mutationOptions: UseMutationOptions<CompleteStoryFieldResponse, DefaultError, Options<CompleteStoryFieldData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const autoGenerateChapterScenesMutation = (options?: Partial<Options<AutoGenerateChapterScenesData>>): UseMutationOptions<AutoGenerateChapterScenesResponse, DefaultError, Options<AutoGenerateChapterScenesData>> => {
    const mutationOptions: UseMutationOptions<AutoGenerateChapterScenesResponse, DefaultError, Options<AutoGenerateChapterScenesData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await autoGenerateChapterScenes({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listChapterMangaPagesQueryKey = (options: Options<ListChapterMangaPagesData>) => createQueryKey('listChapterMangaPages', options);

/**
 * List manga pages for a chapter
 */
export const listChapterMangaPagesOptions = (options: Options<ListChapterMangaPagesData>) => queryOptions<ListChapterMangaPagesResponse, DefaultError, ListChapterMangaPagesResponse, ReturnType<typeof listChapterMangaPagesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listChapterMangaPages({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listChapterMangaPagesQueryKey(options)
});
...
export const listProjectDramaVideosQueryKey = (options: Options<ListProjectDramaVideosData>) => createQueryKey('listProjectDramaVideos', options);

/**
 * List Korean drama videos for a project
 */
export const listProjectDramaVideosOptions = (options: Options<ListProjectDramaVideosData>) => queryOptions<ListProjectDramaVideosResponse, DefaultError, ListProjectDramaVideosResponse, ReturnType<typeof listProjectDramaVideosQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const archiveDramaVideoMutation = (options?: Partial<Options<ArchiveDramaVideoData>>): UseMutationOptions<ArchiveDramaVideoResponse, DefaultError, Options<ArchiveDramaVideoData>> => {
    const mutationOptions: UseMutationOptions<ArchiveDramaVideoResponse, DefaultError, Options<ArchiveDramaVideoData>> = {
        mutationFn: async (fnOptions) => {
...
export const listDramaVideosQueryKey = (options: Options<ListDramaVideosData>) => createQueryKey('listDramaVideos', options);

/**
 * List Korean drama videos for scene
 */
export const listDramaVideosOptions = (options: Options<ListDramaVideosData>) => queryOptions<ListDramaVideosResponse, DefaultError, ListDramaVideosResponse, ReturnType<typeof listDramaVideosQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const listMangaPageDramaVideosQueryKey = (options: Options<ListMangaPageDramaVideosData>) => createQueryKey('listMangaPageDramaVideos', options);

/**
 * List Korean drama videos for a manga page
 */
export const listMangaPageDramaVideosOptions = (options: Options<ListMangaPageDramaVideosData>) => queryOptions<ListMangaPageDramaVideosResponse, DefaultError, ListMangaPageDramaVideosResponse, ReturnType<typeof listMangaPageDramaVideosQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const generateDramaVideoMutation = (options?: Partial<Options<GenerateDramaVideoData>>): UseMutationOptions<GenerateDramaVideoResponse, DefaultError, Options<GenerateDramaVideoData>> => {
    const mutationOptions: UseMutationOptions<GenerateDramaVideoResponse, DefaultError, Options<GenerateDramaVideoData>> = {
        mutationFn: async (fnOptions) => {
...
export const getDramaVideoFileQueryKey = (options: Options<GetDramaVideoFileData>) => createQueryKey('getDramaVideoFile', options);

/**
 * Get drama video file
 */
export const getDramaVideoFileOptions = (options: Options<GetDramaVideoFileData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof getDramaVideoFileQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
