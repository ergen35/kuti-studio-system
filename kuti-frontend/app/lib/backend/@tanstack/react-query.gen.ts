...
import { archiveCharacter, archiveProject, autoGenerateChapterScenes, cancelGenerationJob, cloneProject, completeStoryField, createChapter, createCharacter, createExport, createGenerationJob, createNarrativeRole, createProject, createRelation, createScene, createSceneConfig, createTome, createVoiceSample, deleteChapter, deleteCharacter, deleteCharacterImage, deleteProject, deleteRelation, deleteScene, deleteSceneConfig, deleteSceneMangaPage, deleteTome, downloadBoardArtifact, downloadExport, exportProject, generateCharacterImage, generateCharacterProfileDraft, generateSceneManga, get_, getApiInngest, getCharacter, getConfig, getExport, getGenerationBoard, getGenerationJob, getGenerationPanelImage, getHealth, getHealthz, getIndex, getProject, getProjectCharacterImages, getReferenceSuggestions, getStorySummary, importProject, listChapterMangaPages, listChapters, listCharacterImages, listCharacters, listExports, listGenerationBoards, listGenerationJobs, listModels, listNarrativeRoles, listProjects, listSceneConfigs, listSceneMangaPages, listScenes, listSceneTypes, listStoryCompletionModels, listTomes, listWarnings, openProject, type Options, postApiInngest, previewPrompt, putApiInngest, relaunchGenerationJob, scanWarnings, setCharacterImageActive, setDefaultConfig, updateChapter, updateCharacter, updateGenerationPanel, updateProject, updateRelation, updateScene, updateSceneConfig, updateSceneMangaPage, updateTome, updateWarning, validateGenerationBoard } from '../sdk.gen';
import type { ArchiveCharacterData, ArchiveCharacterResponse, ArchiveProjectData, ArchiveProjectResponse, AutoGenerateChapterScenesData, AutoGenerateChapterScenesResponse, CancelGenerationJobData, CancelGenerationJobResponse, CloneProjectData, CloneProjectResponse, CompleteStoryFieldData, CompleteStoryFieldResponse, CreateChapterData, CreateChapterResponse, CreateCharacterData, CreateCharacterResponse, CreateExportData, CreateExportResponse, CreateGenerationJobData, CreateGenerationJobResponse, CreateNarrativeRoleData, CreateNarrativeRoleResponse, CreateProjectData, CreateProjectResponse, CreateRelationData, CreateRelationResponse, CreateSceneConfigData, CreateSceneConfigResponse, CreateSceneData, CreateSceneResponse, CreateTomeData, CreateTomeResponse, CreateVoiceSampleData, CreateVoiceSampleResponse, DeleteChapterData, DeleteCharacterData, DeleteCharacterImageData, DeleteProjectData, DeleteProjectResponse, DeleteRelationData, DeleteSceneConfigData, DeleteSceneData, DeleteSceneMangaPageData, DeleteTomeData, DownloadBoardArtifactData, DownloadExportData, ExportProjectData, GenerateCharacterImageData, GenerateCharacterProfileDraftData, GenerateCharacterProfileDraftResponse, GenerateSceneMangaData, GenerateSceneMangaResponse, GetApiInngestData, GetCharacterData, GetCharacterResponse, GetConfigData, GetConfigResponse, GetData, GetExportData, GetExportResponse, GetGenerationBoardData, GetGenerationBoardResponse, GetGenerationJobData, GetGenerationJobResponse, GetGenerationPanelImageData, GetHealthData, GetHealthResponse, GetHealthzData, GetIndexData, GetProjectCharacterImagesData, GetProjectCharacterImagesResponse, GetProjectData, GetProjectResponse, GetReferenceSuggestionsData, GetStorySummaryData, GetStorySummaryResponse, ImportProjectData, ImportProjectResponse, ListChapterMangaPagesData, ListChapterMangaPagesResponse, ListChaptersData, ListCharacterImagesData, ListCharacterImagesResponse, ListCharactersData, ListCharactersResponse, ListExportsData, ListExportsResponse, ListGenerationBoardsData, ListGenerationJobsData, ListModelsData, ListModelsResponse, ListNarrativeRolesData, ListNarrativeRolesResponse, ListProjectsData, ListProjectsResponse, ListSceneConfigsData, ListSceneConfigsResponse, ListSceneMangaPagesData, ListSceneMangaPagesResponse, ListScenesData, ListSceneTypesData, ListSceneTypesResponse, ListStoryCompletionModelsData, ListStoryCompletionModelsResponse, ListTomesData, ListWarningsData, ListWarningsResponse, OpenProjectData, OpenProjectResponse, PostApiInngestData, PreviewPromptData, PreviewPromptResponse, PutApiInngestData, RelaunchGenerationJobData, RelaunchGenerationJobResponse, ScanWarningsData, ScanWarningsResponse, SetCharacterImageActiveData, SetCharacterImageActiveResponse, SetDefaultConfigData, SetDefaultConfigResponse, UpdateChapterData, UpdateChapterResponse, UpdateCharacterData, UpdateCharacterResponse, UpdateGenerationPanelData, UpdateProjectData, UpdateProjectResponse, UpdateRelationData, UpdateRelationResponse, UpdateSceneConfigData, UpdateSceneConfigResponse, UpdateSceneData, UpdateSceneMangaPageData, UpdateSceneMangaPageResponse, UpdateSceneResponse, UpdateTomeData, UpdateTomeResponse, UpdateWarningData, UpdateWarningResponse, ValidateGenerationBoardData, ValidateGenerationBoardResponse } from '../types.gen';
...
export const listSceneTypesQueryKey = (options: Options<ListSceneTypesData>) => createQueryKey('listSceneTypes', options);

/**
 * List available scene types
 */
export const listSceneTypesOptions = (options: Options<ListSceneTypesData>) => queryOptions<ListSceneTypesResponse, DefaultError, ListSceneTypesResponse, ReturnType<typeof listSceneTypesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listSceneTypes({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listSceneTypesQueryKey(options)
});
