...
export type ImportProjectResponse =
  ImportProjectResponses[keyof ImportProjectResponses];
...
export type OpenProjectResponse =
  OpenProjectResponses[keyof OpenProjectResponses];
...
export type CloneProjectResponse =
  CloneProjectResponses[keyof CloneProjectResponses];
...
export type ListCharactersResponse =
  ListCharactersResponses[keyof ListCharactersResponses];
...
export type CreateCharacterResponse =
  CreateCharacterResponses[keyof CreateCharacterResponses];
...
export type GetProjectCharacterImagesResponse =
  GetProjectCharacterImagesResponses[keyof GetProjectCharacterImagesResponses];
...
export type GetCharacterResponse =
  GetCharacterResponses[keyof GetCharacterResponses];
...
export type UpdateCharacterResponse =
  UpdateCharacterResponses[keyof UpdateCharacterResponses];
...
export type ArchiveCharacterResponse =
  ArchiveCharacterResponses[keyof ArchiveCharacterResponses];
...
export type CreateRelationResponse =
  CreateRelationResponses[keyof CreateRelationResponses];
...
export type UpdateRelationResponse =
  UpdateRelationResponses[keyof UpdateRelationResponses];
...
export type CreateVoiceSampleResponse =
  CreateVoiceSampleResponses[keyof CreateVoiceSampleResponses];
...
export type ListCharacterImagesResponse =
  ListCharacterImagesResponses[keyof ListCharacterImagesResponses];
...
export type GetStorySummaryResponse =
  GetStorySummaryResponses[keyof GetStorySummaryResponses];
...
export type ListStoryCompletionModelsResponse =
  ListStoryCompletionModelsResponses[keyof ListStoryCompletionModelsResponses];
...
export type CompleteStoryFieldResponse =
  CompleteStoryFieldResponses[keyof CompleteStoryFieldResponses];
...
export type CreateChapterResponse =
  CreateChapterResponses[keyof CreateChapterResponses];
...
export type UpdateChapterResponse =
  UpdateChapterResponses[keyof UpdateChapterResponses];
...
export type CreateSceneResponse =
  CreateSceneResponses[keyof CreateSceneResponses];
...
export type UpdateSceneResponse =
  UpdateSceneResponses[keyof UpdateSceneResponses];
...
export type CreateGenerationJobResponse =
  CreateGenerationJobResponses[keyof CreateGenerationJobResponses];
...
export type GetGenerationJobResponse =
  GetGenerationJobResponses[keyof GetGenerationJobResponses];
...
export type GetGenerationBoardResponse =
  GetGenerationBoardResponses[keyof GetGenerationBoardResponses];
...
export type ValidateGenerationBoardResponse =
  ValidateGenerationBoardResponses[keyof ValidateGenerationBoardResponses];
...
export type CancelGenerationJobResponse =
  CancelGenerationJobResponses[keyof CancelGenerationJobResponses];
...
export type RelaunchGenerationJobResponse =
  RelaunchGenerationJobResponses[keyof RelaunchGenerationJobResponses];
...
export type ListProjectDramaVideosResponse =
  ListProjectDramaVideosResponses[keyof ListProjectDramaVideosResponses];

export type ArchiveDramaVideoData = {
  body?: never;
  path: {
    projectId: string;
    dramaVideoId: string;
...
export type ArchiveDramaVideoResponses = {
  /**
   * Response for status 200
   */
  200: {
...
export type ArchiveDramaVideoResponse =
  ArchiveDramaVideoResponses[keyof ArchiveDramaVideoResponses];
...
export type ImportAssetResponse =
  ImportAssetResponses[keyof ImportAssetResponses];
...
export type ArchiveAssetResponse =
  ArchiveAssetResponses[keyof ArchiveAssetResponses];
...
export type CreateAssetLinkResponse =
  CreateAssetLinkResponses[keyof CreateAssetLinkResponses];
...
export type ListSceneConfigsResponse =
  ListSceneConfigsResponses[keyof ListSceneConfigsResponses];
...
export type CreateSceneConfigResponse =
  CreateSceneConfigResponses[keyof CreateSceneConfigResponses];
...
export type UpdateSceneConfigResponse =
  UpdateSceneConfigResponses[keyof UpdateSceneConfigResponses];
...
export type SetDefaultConfigResponse =
  SetDefaultConfigResponses[keyof SetDefaultConfigResponses];
...
export type GenerateSceneMangaResponse =
  GenerateSceneMangaResponses[keyof GenerateSceneMangaResponses];
...
export type PreviewPromptResponse =
  PreviewPromptResponses[keyof PreviewPromptResponses];
...
export type ListSceneMangaPagesResponse =
  ListSceneMangaPagesResponses[keyof ListSceneMangaPagesResponses];
...
export type UpdateSceneMangaPageResponse =
  UpdateSceneMangaPageResponses[keyof UpdateSceneMangaPageResponses];
...
export type ListDramaVideosResponse =
  ListDramaVideosResponses[keyof ListDramaVideosResponses];
...
export type ListMangaPageDramaVideosResponse =
  ListMangaPageDramaVideosResponses[keyof ListMangaPageDramaVideosResponses];
...
export type GenerateDramaVideoResponse =
  GenerateDramaVideoResponses[keyof GenerateDramaVideoResponses];
...
export type ListBranchesResponses = {
  ...
  200: Array<{
    branchName: string;
    versionCount: number;
    latestVersionId: string | unknown;
    latestVersionLabel: string | unknown;
    latestCreatedAt: string | unknown;
    latestSnapshotCapturedAt: string | unknown;
...
export type CompareVersionsResponse =
  CompareVersionsResponses[keyof CompareVersionsResponses];
...
export type RestoreVersionResponse =
  RestoreVersionResponses[keyof RestoreVersionResponses];
...
export type ListWarningsResponse =
  ListWarningsResponses[keyof ListWarningsResponses];
...
export type ScanWarningsResponse =
  ScanWarningsResponses[keyof ScanWarningsResponses];
...
export type UpdateWarningResponse =
  UpdateWarningResponses[keyof UpdateWarningResponses];
...
export type ListExportsResponse =
  ListExportsResponses[keyof ListExportsResponses];
...
export type CreateExportResponse =
  CreateExportResponses[keyof CreateExportResponses];
